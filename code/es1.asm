...
!scr"i'll have rush's new album soon..like i hope today... i just got pink floyd's (n"
!scr"ot bad!)   well later all!          esi #1/rush #1/soho #1                      "
!byte $00
...
lc174
            lda ($fb),y
            bne +
            lda #<la500+1                   ; unsure, was 01 before
            sta $fb 
            lda #>la500+1                   ; unsure, was a5 before
            sta $fc
            jmp lc174
+
            sta SCROLLER_POS
...
screenmem
            ...
            stx $fe
            sty $fd
            ldx #>image_colors_end-1        ; end address for copy
            ldy #<image_colors_end-1
            jsr copy
            ldx #>image_colram
            ldy #<image_colram
            stx $fc
            ...
            stx $fe
            sty $fd
            ldx #>image_colram_end-1        ; end address for copy
            ldy #<image_colram_end-1
            jsr copy
